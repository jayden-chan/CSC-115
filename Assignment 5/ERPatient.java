...
public class ERPatient implements Comparable<ERPatient> {
     ...
     * @return a number less than 0 indicates that this patient has higher priority.
     * 	A number greater than 0 indicates that the other patient has higher priority.
